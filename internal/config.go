...
type Config struct {
	...
	Scopes          string   `env:"SCOPES" long:"scopes" description:"OAuth scopes to request from the user" required:"true" required:"true" default:"https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email"`
